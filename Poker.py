...
print("1: multijoueurs - 2: solo")
choice = int(input("choisir entre 1 et 2 ? "))       # Demande a quel mode on veut jouer

if choice == 1 or choice == 2:      # Si on veut jouer alors
      ...
      while game != "stop":                              # Tant que on écrit pas "stop"
            ...
            game = str(input("ecrire 'stop' pour arreter "))           # Demande si on veut continuer de jouer au poker, si on écrit "0" la partie se termine
            A = True